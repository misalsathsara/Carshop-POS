          ...
          <form class="" action="add_product.php" method="POST">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <small class="float-right">Products Category not listed here? <a href="#"data-toggle="modal" data-target="#addProductBrandModal">Add new</a> </small>
              </div>
              <!-- <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="product_name" value="" placeholder="Enter product name..." required>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="product_cost_price" value="" placeholder="Enter Cost price per item..." required>
              </div>

              <div class="form-group">
                <label for="">Product Price <small class="text-muted">(Item Price)</small> </label>
                <input type="number" class="form-control" name="product_price" value="" placeholder="Enter Item price per item..." required>
              </div>

              <div class="form-group">
                <label for="">Product Selling Price <small class="text-muted">(Sell Price)</small> </label>
                <input type="number" class="form-control" name="product_selling_price" value="" placeholder="Enter Sell price per item..." required>
              </div>
              <div class="form-group">
                <label for="">Product Stock <small>(How many products are you adding in stock?)</small> </label>
                <input type="number" class="form-control" name="product_stock" value="" placeholder="Enter number of items..." required>
          ...
          <form class="" action="add-category.php" method="POST">
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="category_name" value="" placeholder="Enter Category name here..." required>
    ...
    <div class="modal-content">
      ...
      <form action="product-edit.php" method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label id="editProductIdLabel" for="editProductName">Product ID</label>
          </div>
